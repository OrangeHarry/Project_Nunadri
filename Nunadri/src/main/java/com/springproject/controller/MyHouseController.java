...
public class MyHouseController {
	...
	public String insertMyhouseBoard(NoticeMyhouseVO noticeInsert, HttpServletRequest request,
		...
		try {
			...
			List<FileMyhouseVO> fileList = fileUtils.parseFileInfo(noticeInsert.getHouseNo(), category, myhouseNo,
					request, mhsr);
	...
	public String smallGroupInsert() {
		return "view/myhome/smallGroup/boarder_smallgroup_insert";
	}
	...
	public String peopleJoin(NoticeMyhouseVO vo, MyhouseCommentVO commentVO, @AuthenticationPrincipal SecurityUser user,
			Model model) {
