...
public class CustomerServiceController {
	...
	public String insertCustomerServiceBoard(CustomerServiceVO customerBoardInsert,
			@AuthenticationPrincipal SecurityUser user, HttpServletRequest request, MultipartHttpServletRequest mhsr) {
	...
	public String updateCustomerService(CustomerServiceVO customerBoardUpdate,
			@AuthenticationPrincipal SecurityUser user, @RequestParam("arrNo") int[] arr, HttpServletRequest request,
		...
		return "redirect:/CustomerServiceBoardDetail/" + customerBoardUpdate.getQnaNo() + "/"
				+ customerBoardUpdate.getId();
	}
