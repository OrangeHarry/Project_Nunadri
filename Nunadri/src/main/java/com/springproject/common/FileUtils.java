...
public class FileUtils {
	...
	public List<MemberVO> parseProfileInfo(HttpServletRequest request, MultipartHttpServletRequest profile, String id)
			throws Exception {
	...
	// 고객센터 파일
	public List<FileCustomerServiceVO> parseFileInfo(String id, int seq, HttpServletRequest request,
			MultipartHttpServletRequest mhsr) throws Exception {
